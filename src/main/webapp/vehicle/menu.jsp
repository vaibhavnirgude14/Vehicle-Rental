 <!-- Topbar Start -->
    ...
    <div class="container-fluid position-relative nav-bar p-0">
      ...
      %>
          ...
          <a class="nav-link" href="viewcategory.jsp">Add Category</a>
          <a class="nav-link" href="viewvehicle.jsp">Add Vehicle</a>
          <a class="nav-link" href="orders.jsp">order</a>
          <a class="nav-link" href="logout.jsp">Logout</a>
          <a class="nav-link" href="logoutv.jsp">Logout from vender</a>
